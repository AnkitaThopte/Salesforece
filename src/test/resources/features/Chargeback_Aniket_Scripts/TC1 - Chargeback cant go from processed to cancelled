...
#    And I click "Chargeback" radio button
    ...
    And I edit Chargeback Bank Action from Chargeback processed to Chargeback cancelled under Chagreback Information
    And I click on Save button
    Then I verify whether the correct error "Chargeback status cannot be modified from processed to cancelled." message displayed
