...
#    And I click on Save button
    ...
    Then I verify message "Error<new_line>Chargeback Bank Final Notification Date needs to be greater than or equal to Chargeback Actual Response Date." generated


    Examples:
      | Chargeback Bank Action | Chargeback Received On | Chargeback Reference Number | Chargeback Response By | Chargeback Actual Response Date | Chargeback SST Response | Chargeback Bank Final Notification Date |
      | Chargeback cancelled   | 2019-08-30             | CN100102                    | 2019-08-30             | 2019-08-30                      | Evidence provided       | 2019-08-07                              |